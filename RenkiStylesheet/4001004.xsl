...
<xsl:template match="/">
	<html>
		<head>
			...
			<title>船員保険厚生年金保険被保険者標準報酬改定一覧表</title>
			<style type="text/css">
			<!--テーブル属性-->
				table.outline						<!--外枠-->
				{
					...
					<tr>
						<td style="vertical-align:top;">
							...
							<table class="detail title">
								<tr>
									<td><xsl:value-of select="通知書名称" />船員保険厚生年金保険被保険者標準報酬改定一覧表</td>
								</tr>
							</table>
							<br/>
							<br/>
							...
							<table class="detail" cellpadding="5" cellspacing="0">
								...
								<tr class="h_data1">
									<td class="normalct linetlr"><xsl:value-of select="船舶所有者整理記号x事務所略称名" /></td>
							...
							<table class="detail" cellpadding="0" cellspacing="0">
								...
								<tr class="h_data2">
									...
									<td class="midashict allline" rowspan="3">種別</td>
									<td class="midashict allline" rowspan="3">職務</td>
									<td class="midashict allline" colspan="3" rowspan="3">標準報酬月額<br/>変更年月</td>
									<td class="midashict allline" colspan="2" rowspan="3">従前の<br/>標準<br/>報酬月額</td>
									<td class="midashict allline" rowspan="3" style="writing-mode:horizontal-rl">報酬月額</td>
									<td class="midashi7pt_ct allline">金銭によるものの額</td>
									<td class="midashict allline" colspan="2" rowspan="3">標準<br/>報酬月額</td>
									<td class="midashict allline" rowspan="3">備　　　考</td>
								</tr>
								<tr class="h_data2">
									<td class="midashi7pt_ct allline">現物によるものの額</td>
								</tr>
								<tr class="h_data2">
									<td class="midashi7pt_ct allline">合計</td>
								</tr>
								<!--　ダミー行の設定　-->
								<tr>
				...
				<table class="detail" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="normal10 linel">
							<xsl:if test="電話x市外局番='' and 電話x局番='' and 電話x番号=''">
							</xsl:if>
...
<xsl:template match="_被保険者">
	...
	<tr class="h_data3">
		...
		<td class="normalct allline" rowspan="2"><xsl:value-of select="種別" /></td>
		<xsl:if test="職務xその他=''">
		...
		<td class="normalct allline linerclear" rowspan="2"><xsl:value-of select="concat(標準報酬月額変更年月x元号,' ')" /></td>
		<td class="normalrt allline linelclear linerclear" rowspan="2"><xsl:value-of select="concat(標準報酬月額変更年月x年,'年')" /></td>
		<td class="normalrt allline linelclear" rowspan="2"><xsl:value-of select="concat(標準報酬月額変更年月x月,'月')" /></td>
		...
		<td class="normal allline" rowspan="2"><xsl:value-of select="備考" /></td>
	</tr>
